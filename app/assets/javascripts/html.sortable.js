...
(function(global, factory) {
  ...
  function matrix(el, selfOnly) {
    ...
    var matrixFn =
      window.DOMMatrix || window.WebKitCSSMatrix || window.CSSMatrix;
    /*jshint -W056 */
  ...
  var PluginManager = {
    ...
    pluginEvent: function pluginEvent(eventName, sortable, evt) {
      ...
      for (var i in plugins) {
        ...
        if (sortable[plugins[i].pluginName][eventNameGlobal]) {
          this.eventCanceled = !!sortable[plugins[i].pluginName][
            eventNameGlobal
          ](
            _objectSpread(
              {
    ...
    initializePlugins: function initializePlugins(sortable, el, defaults) {
      for (var i in plugins) {
        ...
        if (!sortable.options[pluginName] && !plugins[i].initializeByDefault)
          continue;
    ...
    modifyOption: function modifyOption(sortable, name, value) {
      ...
      for (var i in plugins) {
        ...
        if (
          plugins[i].optionListeners &&
          typeof plugins[i].optionListeners[name] === "function"
        ) {
          modifiedValue = plugins[i].optionListeners[name].call(
  ...
  function dispatchEvent(_ref) {
    ...
    var allEventOptions = _objectSpread(
      {},
      eventOptions,
        ...
        if (tapEvt) {
          var options = this.options,
            ...
            translate3d = evt.touches
              ...
              : "translate(" + dx + "px," + dy + "px)"; // only set the status to dragging, when we are actually dragging
        ...
        if (
          ...
          if (
            ...
            var direction = 0,
              ...
              scrolledPastTop =
                isScrolledPast(target, null, "top", "top") ||
                isScrolledPast(dragEl, null, "top", "top"),
  ...
  var autoScroll = throttle(function(evt, options, rootEl, isFallback) {
    ...
    do {
      ...
      var vx =
        canScrollX &&
        (Math.abs(right - evt.clientX) <= sens &&
          scrollPosX + width < scrollWidth) -
          (Math.abs(left - evt.clientX) <= sens && !!scrollPosX);
      var vy =
        canScrollY &&
        (Math.abs(bottom - evt.clientY) <= sens &&
          scrollPosY + height < scrollHeight) -
          (Math.abs(top - evt.clientY) <= sens && !!scrollPosY);
    ...
    MultiDrag.prototype = {
      ...
      setupClone: function setupClone(_ref2) {
        ...
        for (var i in multiDragElements) {
          ...
          toggleClass(
            multiDragClones[i],
            sortable.options.selectedClass,
            false
          );
          multiDragElements[i] === dragEl$1 &&
            toggleClass(
              multiDragClones[i],
              sortable.options.chosenClass,
              false
            );
        }
      ...
      hideClone: function hideClone(_ref5) {
        ...
        for (var i in multiDragClones) {
          ...
          if (
            sortable.options.removeCloneOnHide &&
            multiDragClones[i].parentNode
          ) {
      ...
      drop: function drop(_ref12) {
        ...
        if (!dragStarted) {
          ...
          if (!~multiDragElements.indexOf(dragEl$1)) {
            ...
            if (
              (!options.multiDragKey || this.multiDragKeyDown) &&
              evt.shiftKey &&
              lastMultiDragSelect &&
            ...
            if (!initialFolding) {
              ...
              if (oldIndex === index(dragEl$1)) {
                ...
                for (var _i6 in multiDragElements) {
                  if (
                    multiDragElements[_i6].sortableIndex !==
                    index(multiDragElements[_i6])
                  ) {
                    update = true;
                    break;
                  }
        ...
        if (
          ...
          for (var _i8 in multiDragClones) {
            multiDragClones[_i8].parentNode &&
              multiDragClones[_i8].parentNode.removeChild(multiDragClones[_i8]);
          }
        }
      },
      ...
      _deselectMultiDrag: function _deselectMultiDrag(evt) {
        ...
        if (
          ...
          closest(
            evt.target,
            this.sortable.options.draggable,
            this.sortable.el,
            false
          )
        )
      ...
      eventOptions: function eventOptions() {
        ...
        multiDragElements.forEach(function(element) {
          ...
          if (folding && element !== dragEl$1) {
            ...
            newIndex = index(
              element,
              ":not(." + _this.options.selectedClass + ")"
            );
          } else {
  ...
  function insertMultiDragElements(clonesInserted, rootEl) {
    for (var i in multiDragElements) {
      var target =
        rootEl.children[
          multiDragElements[i].sortableIndex + (clonesInserted ? Number(i) : 0)
        ];
  ...
  function insertMultiDragClones(elementsInserted, rootEl) {
    for (var i in multiDragClones) {
      var target =
        rootEl.children[
          multiDragClones[i].sortableIndex + (elementsInserted ? Number(i) : 0)
        ];
  ...
  function removeMultiDragElements() {
    for (var i in multiDragElements) {
      if (multiDragElements[i] === dragEl$1) continue;
      multiDragElements[i].parentNode &&
        multiDragElements[i].parentNode.removeChild(multiDragElements[i]);
    }
  }
